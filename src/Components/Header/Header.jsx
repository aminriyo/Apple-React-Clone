...
import logo from "../../CommonResoucre/images/icons/logo-sm.png"
import search from "../../CommonResoucre/images/icons/search-icon-sm.png"
import cart from "../../CommonResoucre/images/icons/cart-sm.png"
function Header() {
  return (
    // <!-- Header navigation -->
			...
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <div className="navbar-collapse collapse">
			        <ul className="navbar-nav nav-justified w-100 nav-fill">
						<li className="nav-item"><a className="nav-link mac js-scroll-trigger" href="/mac/">Mac</a></li>
